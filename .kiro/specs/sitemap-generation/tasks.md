...
- [ ] 3. Implement unit and property tests
  ...
  - [x] 3.6 Write property test for no duplicate URLs (Property 5)
  ...
  - [x] 3.9 Write property test for standalone HTML page inclusion (Property 8)
  ...
  - [x] 3.10 Write unit tests for edge cases and XML structure
