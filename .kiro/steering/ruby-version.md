...
Always use Ruby 3.4.1 with chruby for this project.

## Command Pattern

```bash
source /opt/homebrew/share/chruby/chruby.sh && chruby ruby-3.4.1 && <command>
```
...
- Never run Ruby/Jekyll commands without first activating chruby with ruby-3.4.1
